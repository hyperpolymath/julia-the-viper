...
JtV enforces strict *separation* between Control (Turing-complete, undecidable) and Data (Total, decidable) languages. This grammatical boundary makes code injection impossible by design—not through runtime checks, but through architectural guarantees.

The name honors *Julia Robinson* (1919–1985) and the Matiyasevich–Robinson theorem, celebrating what becomes possible when different traditions collaborate—just as JtV bridges security and expressiveness through principled separation.
...
Status: *~60% Complete* (see link:STATUS.md[STATUS.md])
...
Julia the Viper targets compliance with the link:https://rhodium-standard.org[Rhodium Standard Repository] framework:
...
✅ Complete documentation suite (README, CONTRIBUTING, CODE_OF_CONDUCT, SECURITY) +
✅ RFC 9116 compliant security.txt +
✅ TPCF governance model (3 perimeters defined) +
✅ Tri-licensing (MIT + GPL-3.0 + Palimpsest) +
✅ Nix reproducible builds +
✅ GitLab CI/CD pipeline +
✅ No unsafe Rust code in core +
✅ Offline-first (no network dependencies in core)
