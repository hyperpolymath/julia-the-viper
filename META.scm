...
(define-module (julia-the-viper meta)
...
(define architecture-decisions
  '((adr-001
     ...
     (status . "accepted")
     (date . "2025-12-15")
     (context . "*Harvard Architecture Language for Security-Critical Applications*")
...
(define development-practices
  '((code-style
     (languages . ("Just" "Nix" "Rust" "Scheme" "Tree-sitter Query" "TypeScript"))
...
(cross-platform-status
  ...
  (gitlab-mirror
    (path "hyperpolymath/maaf/4a-languages/julia-the-viper")
    (url "https://gitlab.com/hyperpolymath/maaf/4a-languages/julia-the-viper")
  ...
  (reconciliation-instructions
    ...
    ";; git remote add gitlab https://gitlab.com/hyperpolymath/maaf/4a-languages/julia-the-viper.git"
    ";; git fetch gitlab"
    ";;"
